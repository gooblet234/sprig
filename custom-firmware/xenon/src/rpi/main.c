...
//version because i want to be cool and have branding
...
static int load_new_scripts(void) {
    ...
    switch (current_command) {
        ...
        case 1: // version
            printf("XENON:%sEND", VERSION);
            return 0;
        case 2: // legacy (1,2,3,4)
            puts("legacy detected haha");
            return 0;
        default:
            return 0;
    }
...
typedef struct {
  ...
  char upload_game_screen[512];
  
  void init_screen() {
    snprintf(upload_game_screen, sizeof(upload_game_screen), 
                                    "                    \n"
                                    " XENON v%s\n"
                                    "                    \n"
                                    "                    \n"
